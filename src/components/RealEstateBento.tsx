      ...
      <div className="flex items-center gap-1.5 w-full justify-center">
        {categories.map((cat, idx) => {
          ...
          return (
            <motion.div
              key={cat}
              className={`px-2.5 py-1.5 rounded-md text-[10px] uppercase font-bold tracking-wider transition-all border ${isActive
  ...
  return (
    <div className="flex items-center justify-center h-full gap-3">
      {shields.map((shield) => (
        <motion.div
          key={shield.id}
          className={`px-3.5 py-2.5 rounded-lg flex flex-col items-center justify-center border transition-all ${shield.active
  ...
  return (
    <section className="bg-[#0B231B] text-white py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden border-t border-[#C89B3C]/20" id="por-que-matheus">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-4 md:gap-5 md:auto-rows-[230px] [&>*]:min-h-[260px] md:[&>*]:min-h-0">

          {/* 01 · CURADORIA SELETIVA - Tall (2x2) */}
          <motion.div
            className="md:col-span-2 md:row-span-2 bg-[#122A22]/90 border border-[#C89B3C]/30 rounded-2xl p-5 md:p-7 flex flex-col justify-between hover:border-[#C89B3C] transition-all duration-300 shadow-xl group cursor-pointer"
          ...
          <motion.div
            className="md:col-span-2 bg-[#122A22]/90 border border-[#C89B3C]/30 rounded-2xl p-5 md:p-6 flex flex-col justify-between hover:border-[#C89B3C] transition-all duration-300 shadow-xl group cursor-pointer"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          <motion.div
            className="md:col-span-3 bg-[#122A22]/90 border border-[#C89B3C]/30 rounded-2xl p-5 md:p-6 flex flex-col justify-between hover:border-[#C89B3C] transition-all duration-300 shadow-xl group cursor-pointer"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
